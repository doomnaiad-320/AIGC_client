 ...
 * content later from PostgreSQL without touching the UI layer.
 */
export const homeDiscoverySeedCategories: HomeDiscoveryCategory[] = [
  createCategory("branding-design", "品牌设计", [
    createCase(
      ...
      "/assets/project-assets/home-seeds/discovery/branding-design/cover.webp",
      "Studio Arken",
      "/assets/project-assets/home-seeds/discovery/avatars/branding-design.svg",
      549,
      7,
  ...
  createCategory("poster-and-ads", "海报与广告", [
    createCase(
      "n9d21de",
      "Vintage Car Poster",
      "/assets/project-assets/home-seeds/discovery/poster-and-ads/cover.webp",
      "Retro Workshop",
      "/assets/project-assets/home-seeds/discovery/avatars/poster-and-ads.svg",
      359919,
      286,
  ...
  createCategory("illustration", "插画", [
    createCase(
      "bjde0nh",
      "Cat Tarot Cards",
      "/assets/project-assets/home-seeds/discovery/illustration/cover.webp",
      "Mochi Art",
      "/assets/project-assets/home-seeds/discovery/avatars/illustration.svg",
      2054,
      116,
  ...
  createCategory("ui-design", "UI设计", [
    createCase(
      ...
      "/assets/project-assets/home-seeds/discovery/ui-design/cover.webp",
      "Pixel Forge",
      "/assets/project-assets/home-seeds/discovery/avatars/ui-design.svg",
      4338,
      192,
  ...
  createCategory("character-design", "角色设计", [
    createCase(
      ...
      "/assets/project-assets/home-seeds/discovery/character-design/cover.webp",
      "Dark Carnival",
      "/assets/project-assets/home-seeds/discovery/avatars/character-design.svg",
      749,
      12,
  ...
  createCategory("storyboard-video", "影片与分镜", [
    createCase(
      "ikqo02k",
      "Mixtapes Emotions !",
      "/assets/project-assets/home-seeds/discovery/storyboard-video/cover.webp",
      "Frame Studio",
      "/assets/project-assets/home-seeds/discovery/avatars/storyboard-video.svg",
      3057,
      49,
  ...
  createCategory("product-design", "产品设计", [
    createCase(
      ...
      "/assets/project-assets/home-seeds/discovery/product-design/cover.webp",
      "Future Lab",
      "/assets/project-assets/home-seeds/discovery/avatars/product-design.svg",
      769,
      27,
  ...
  createCategory("architecture-design", "建筑设计", [
    createCase(
      ...
      "/assets/project-assets/home-seeds/discovery/architecture-design/cover.webp",
      "Arc Design",
      "/assets/project-assets/home-seeds/discovery/avatars/architecture-design.svg",
      1453,
      24,
