...
update public.home_example_examples
  set prompt = $p$Make a poster for a music festival in the Bauhaus style. Use a limited color palette of pink, red, and cream. Abstract geometric shapes representing sound waves. Minimalist vertical text.$p$,
      input_mentions = '[{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Generate product photos against a white background, 1 for earrings, 1 for a ring, belonging to the same set as the necklace. Make sure the design across the set is consistent. Maintain a cohesive visual tone suitable for a luxury brand website homepage - minimal, elegant, and timeless.$p$,
      input_mentions = '[{"type":"image","name":"Necklace","imgSrc":"/assets/project-assets/home-seeds/inputs/design/e3-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
  where title = 'Design new pieces for a jewelry collection.';

update public.home_example_examples
  set prompt = $p$Change the product packaging to cucumber flavor.$p$,
      input_mentions = '[{"type":"image","name":"Cocoa Puffs","imgSrc":"/assets/project-assets/home-seeds/inputs/design/e4-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
  where title = 'Generate packaging design variations.';

update public.home_example_examples
  set prompt = $p$A velvet, bright orange sculptural tubular chair.$p$,
      input_mentions = '[{"type":"tool","name":"Midjourney","imgSrc":"/assets/project-assets/home-seeds/icons/midjourney.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Generate 5 different interiors - different furniture pieces, colors, space - in the same style and mood.$p$,
      input_mentions = '[{"type":"image","name":"Interior","imgSrc":"/assets/project-assets/home-seeds/inputs/design/e6-input-1.webp"},{"type":"tool","name":"Gemini Imagen 4","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Minimalist vector cartoon logo for a sushi shop. Use simple, bold, rounded lines. Very clean, modern, and well designed.$p$,
      input_mentions = '[{"type":"tool","name":"Gemini Imagen 4","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$A minimalist product photo of a trendy high-quality ceramic espresso cup and saucer standing on a light wood surface against a clean white wall, with this logo printed in black on the cup. The scene is cinematic and editorial, illuminated by dramatic, warm afternoon light from the side, casting high contrast shadow. The composition is clean and organic. Sharp focus on the cup, warm color palette.$p$,
      input_mentions = '[{"type":"image","name":"Logo","imgSrc":"/assets/project-assets/home-seeds/inputs/common/loomic-logo.png"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Use  to make  the sidewalk board display  this exact ice cream image.$p$,
      input_mentions = '[{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Board","imgSrc":"/assets/project-assets/home-seeds/inputs/branding/e4-input-1.webp"},{"type":"image","name":"Image","imgSrc":"/assets/project-assets/home-seeds/inputs/branding/e4-input-2.webp"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Generate the following images in the same mood and style for the same editorial series: closeup shot of a well-groomed hand fixing an earring; ultra closeup shot of a woman's foot in a stiletto stepping out of a car; closeup shot of the architectural detail of a curved luxuriant staircase; ultra close-up photo of an unmade bed; closeup shot of a delicate dessert in a fine dining restaurant.$p$,
      input_mentions = '[{"type":"image","name":"Reference","imgSrc":"/assets/project-assets/home-seeds/inputs/branding/e5-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$A flat-lay (overhead) product photograph featuring  this piece of jewelry. The jewelry is nestled within a bed of pristine white snow, sinking in deep and snugly. The snow shouldn''t just be a flat base; it should rise up and partially bury the banana. The snow has a texture with small fine coarse ice crystals, creating a three-dimensional, coarse, powered sugar-like surface. The lighting is bright and direct, emphasizing the stark white of the snow and creating subtle micro-shadows that highlight its intricate, uneven texture.$p$,
      input_mentions = '[{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Earrings","imgSrc":"/assets/project-assets/home-seeds/inputs/branding/e6-input-1.webp"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Turn this sketch into a 2D illustration, try 5 different styles.$p$,
      input_mentions = '[{"type":"image","name":"Cat","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e1-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Turn this photo into a detailed ink drawing with fine lines and blue ink tones, drawn on a light grey dot grid notebook page. Maintain aspect ratio.$p$,
      input_mentions = '[{"type":"image","name":"Image","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e2-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Use these objects to generate a surrealist painting; use them however you like and however many times you like.$p$,
      input_mentions = '[{"type":"image","name":"Spoon","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-1.webp"},{"type":"image","name":"Umbrella","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-2.webp"},{"type":"image","name":"Coca-Cola","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-3.webp"},{"type":"image","name":"Egg","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-4.webp"},{"type":"image","name":"Cherry","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-5.webp"},{"type":"image","name":"Hat","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-6.webp"},{"type":"image","name":"Box","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-7.webp"},{"type":"image","name":"Stool","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-8.webp"},{"type":"image","name":"Bunny","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e3-input-9.webp"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Use  to generate a bold, colourful 2D indie illustration of this object  against a playful tablecloth pattern in the same style as  this drawing.$p$,
      input_mentions = '[{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Avocado","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e5-input-1.webp"},{"type":"image","name":"Reference","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e5-input-2.webp"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Expand this illustration  and make the aspect ratio 16:9.$p$,
      input_mentions = '[{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Image","imgSrc":"/assets/project-assets/home-seeds/inputs/illustration/e6-input-1.webp"}]'::jsonb
  where title = 'Expand your illustration.';

-- Fix E-Commerce examples
update public.home_example_examples
  set prompt = $p$Change her top to this sweater.$p$,
      input_mentions = '[{"type":"image","name":"Model","imgSrc":"/assets/project-assets/home-seeds/inputs/e-commerce/e1-input-1.webp"},{"type":"image","name":"Sweater","imgSrc":"/assets/project-assets/home-seeds/inputs/e-commerce/e1-input-2.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Show me a back view and a side view of the model, maintain photography style.$p$,
      input_mentions = '[{"type":"image","name":"Front View","imgSrc":"/assets/project-assets/home-seeds/inputs/e-commerce/e2-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Generate a series of five luxury haute jewelry fashion editorial photographs for a website showcasing this necklace.$p$,
      input_mentions = '[{"type":"image","name":"Necklace","imgSrc":"/assets/project-assets/home-seeds/inputs/design/e3-input-1.webp"},{"type":"tool","name":"Seedream 4","imgSrc":"/assets/project-assets/home-seeds/icons/seedream_3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Generate 5 minimal, creative stylised lifestyle images for this ceramic dish, all in 4:5 aspect ratio.$p$,
      input_mentions = '[{"type":"image","name":"Ceramic","imgSrc":"/assets/project-assets/home-seeds/inputs/e-commerce/e4-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Showcase this sofa in a clean, well decorated, cozy, modern, scandinavian interior with soft daylight and neutral material palette.$p$,
      input_mentions = '[{"type":"image","name":"Sofa","imgSrc":"/assets/project-assets/home-seeds/inputs/e-commerce/e5-input-1.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$A clean, minimalist, and modern ad poster for this perfume product. The bottle is centered in the lower half of the image. The background is a smooth vertical gradient that transitions from a light yellow at the bottom to a pastel bright butter yellow at the top. The poster includes the logo in white, and minimalist, small white sans serif text at the top: '20% Off Our Signature Scent'$p$,
      input_mentions = '[{"type":"image","name":"Logo","imgSrc":"/assets/project-assets/home-seeds/inputs/common/loomic-logo.png"},{"type":"image","name":"Perfume","imgSrc":"/assets/project-assets/home-seeds/inputs/e-commerce/e6-input-2.webp"},{"type":"tool","name":"Nano Banana","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Use this  as the start and end frame, generate a video of the ring rotating in slow motion.$p$,
      input_mentions = '[{"type":"tool","name":"Kling 2.5 Turbo","imgSrc":"/assets/project-assets/home-seeds/icons/kling.svg"},{"type":"image","name":"Ring","imgSrc":"/assets/project-assets/home-seeds/inputs/video/e1-input-1.webp"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Animate the perfume product while keeping the background completely still.$p$,
      input_mentions = '[{"type":"image","name":"Poster","imgSrc":"/assets/project-assets/home-seeds/inputs/video/e2-input-1.webp"},{"type":"tool","name":"Kling 2.5 Turbo","imgSrc":"/assets/project-assets/home-seeds/icons/kling.svg"}]'::jsonb
  where title = 'Turn static ads into scroll-stopping animations.';

update public.home_example_examples
  set prompt = $p$Have the model walk, the camera follows her.$p$,
      input_mentions = '[{"type":"image","name":"Model","imgSrc":"/assets/project-assets/home-seeds/inputs/video/e3-input-1.webp"},{"type":"tool","name":"Kling 2.5 Turbo","imgSrc":"/assets/project-assets/home-seeds/icons/kling.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$A vertical short-form ad for this exact product emphasising lifestyle and mood, with a grainy Kodak film quality. Montage of minimalist furniture details, flowers, butter and toast breakfast spread, sunlight through curtains, person spraying perfume into air. Soft lo-fi soundtrack, muted warm tones, seamless edit.$p$,
      input_mentions = '[{"type":"image","name":"Perfume","imgSrc":"/assets/project-assets/home-seeds/inputs/e-commerce/e6-input-2.webp"},{"type":"tool","name":"Sora 2 Pro","imgSrc":"/assets/project-assets/home-seeds/icons/sora.svg"}]'::jsonb
...
update public.home_example_examples
  set prompt = $p$Generate an 8-second animation using these two exact characters   in this exact  forest scene. A young princess twirls gracefully in the clearing as she meets a playful forest sprite named Finn. Together they discover a glowing magical flower, and swirling sparkles of light rise around them in wonder. The animation style should match a 1930s Disney cel fairy-tale film — expressive, rounded motion, warm painterly lighting, fluid hand-drawn animation feel, and soft orchestral background atmosphere. The voice and movement should evoke the tone of a classic Disney princess animation: gentle, melodic, full of warmth and wonder.$p$,
      input_mentions = '[{"type":"tool","name":"Veo 3.1","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Princess Elara","imgSrc":"/assets/project-assets/home-seeds/inputs/video/e5-input-1.webp"},{"type":"image","name":"Forest Sprite","imgSrc":"/assets/project-assets/home-seeds/inputs/video/e5-input-2.webp"},{"type":"image","name":"Forest Clearing","imgSrc":"/assets/project-assets/home-seeds/inputs/video/e5-input-3.webp"}]'::jsonb
...
values
  (
    ...
    '[{"type":"tool","name":"Nano Banana Pro","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Chair","imgSrc":"/assets/project-assets/home-seeds/inputs/nano-banana-pro/e1-input-1.webp"},{"type":"image","name":"Nightstand","imgSrc":"/assets/project-assets/home-seeds/inputs/nano-banana-pro/e1-input-2.webp"},{"type":"image","name":"Beanbag","imgSrc":"/assets/project-assets/home-seeds/inputs/nano-banana-pro/e1-input-3.webp"},{"type":"image","name":"Table","imgSrc":"/assets/project-assets/home-seeds/inputs/nano-banana-pro/e1-input-4.webp"},{"type":"image","name":"Stool","imgSrc":"/assets/project-assets/home-seeds/inputs/nano-banana-pro/e1-input-5.webp"}]'::jsonb,
    0
  ),
  (
    'nano-banana-pro',
    ...
    '[{"type":"tool","name":"Nano Banana Pro","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"}]'::jsonb,
    1
  ),
  (
    'nano-banana-pro',
  ...
  (
    ...
    '[{"type":"tool","name":"Nano Banana Pro","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Image","imgSrc":"/assets/project-assets/home-seeds/inputs/nano-banana-pro/e5-input-1.webp"}]'::jsonb,
    4
  ),
  (
    'nano-banana-pro',
    ...
    '[{"type":"tool","name":"Nano Banana Pro","imgSrc":"/assets/project-assets/home-seeds/icons/imagen-3.svg"},{"type":"image","name":"Logo","imgSrc":"/assets/project-assets/home-seeds/inputs/common/loomic-logo.png"}]'::jsonb,
    5
  );
